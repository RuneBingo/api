...
export class AddBingo1742587105643 implements MigrationInterface {
    name = 'AddBingo1742587105643'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "bingo" ("id" SERIAL NOT NULL, "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "created_by" integer, "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updated_by" integer, "uuid" uuid NOT NULL DEFAULT uuid_generate_v4(), "language" character varying NOT NULL DEFAULT 'en', "title" character varying NOT NULL, "description" character varying NOT NULL, "private" boolean NOT NULL, "width" integer NOT NULL DEFAULT '5', "height" integer NOT NULL DEFAULT '5', "full_line_value" integer NOT NULL, "start_date" TIMESTAMP WITH TIME ZONE NOT NULL, "end_date" TIMESTAMP WITH TIME ZONE NOT NULL, "started_at" TIMESTAMP WITH TIME ZONE, "started_by" integer, "ended_at" TIMESTAMP WITH TIME ZONE, "ended_by" integer, "canceled_at" TIMESTAMP WITH TIME ZONE, "canceled_by" integer, CONSTRAINT "UQ_f60383e8ca8d750a8bf7a45f7b6" UNIQUE ("uuid"), CONSTRAINT "PK_852d0aee265c4f8df4d04873f21" PRIMARY KEY ("id"))`);
