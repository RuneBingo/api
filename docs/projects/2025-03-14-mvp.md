...
Returns a [BingoTeamDto](#bingoteamdtowithcompletionandparticipants), or a 404 status code if the bingo or the team doesn't exist, or if the requester is not allowed to see it.
...
Returns a [PaginatedDto](#paginateddto)<[BingoTileCompletionDto](#bingotilecompletiondto)>, or a 404 status code if the bingo doesn't exist, or if the requester is not allowed to see it.
